package boggle; /******************************************************************************
 *  Compilation:  javac boggle.BoggleGame.java
 *  Execution:    java boggle.BoggleGame [m n]
 *  Dependencies: boggle.BoggleSolver.java boggle.BoggleBoard.java
 ...
 *
 *  % javac boggle.BoggleGame.java
 *  
 *  % java boggle.BoggleGame
 *
 *  % java -Xmx300m boggle.BoggleGame 3 7
 *  
            ...
            public void run() {
                ...
                if (args.length == 0) {
                    ...
                    try {
                        ...
                        System.err.println("Usage: java boggle.BoggleGame " +
                                           "\nor:    java boggle.BoggleGame [rows]" +
                                           "\nor:    java boggle.BoggleGame [rows] [cols]");
                        System.exit(1);
                    }
                }
